...
//------------------------ Settings-----------------------------------
//--------------------------------------------------------------------
char ssid[] = "BanHoe"; //  Change this to your network SSID (name).
char pass[] = "46372819@";    // Change this your network password
...
//-- published settings
const char* publishTopic ="channels/23265948/publish";   //REPLACE THE NUMBER 114938 WITH YOUR channel ID  

//-- subscribed settings Virtuino command 1   
const char* subscribeTopicFor_Command_1="channels/23265948/subscribe/fields/field1";   //REPLACE THE NUMBER 114938 WITH YOUR channel ID  
...
const unsigned long postingInterval = 3L * 1000L; // Post data every 20 seconds.
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect("AQ0TNxAEGzkpKTozGS0fGxU", "AQ0TNxAEGzkpKTozGS0fGxU","DqS9WTqaYj0OawJhVw28n/0M")) {  
...
void loop() {
  ...
  dataText = "field1=" + String(sensorValue_1));
  topic="channels/23265948/publish"
  client.publish(topic,dataText)  
